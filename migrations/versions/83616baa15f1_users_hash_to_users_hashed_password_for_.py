...
def upgrade():
    ...
    op.add_column('users', sa.Column('hashed_password', sa.String(length=120), nullable=False))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('users', sa.Column('hash', sa.VARCHAR(length=120), autoincrement=False, nullable=False))
