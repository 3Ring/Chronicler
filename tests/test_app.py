...
class DB_Test(unittest.TestCase):
    ...
    def test_1_users(self):
        ...
        with self.assertRaises(Exception):
            no_password = Users(name=self.strings['lower_short'], email=self.strings['lower_long'])
        ...
        with self.assertRaises(Exception):
            not_unique = Users(name=self.strings['lower_short'], email=self.strings['lower_long'], hash=generate_password_hash(self.strings['upper_super']))
