...
#######################################
    ...
    class CreateAdmins():
        ...
        def users(cls):
            ...
            cls.models.Users.create(id = cls.d.UserAdmin.id
        ...
        def games(cls):
            ...
            cls.models.Games.create(id = cls.d.GameBugs.id
        ...
        def characters(cls):
            ...
            cls.models.Characters.create(id = cls.d.CharacterTutorial.id
    ...
    class CreateOrphanage():
        ...
        def users(cls):
            ...
            """
            cls.models.Users.create(id = cls.d.UserOrphanage.id
        ...
        def images(cls):
            ...
            """
            cls.models.Images.create(id = cls.d.ImageOrphanage.id
        ...
        def games(cls):
            ...
            """
            cls.models.Games.create(id = cls.d.GameOrphanage.id
        ...
        def characters(cls):
            ...
            """
            cls.models.Characters.create(id = cls.d.CharacterOrphanage.id
        ...
        def sessions(cls):
            ...
            """
            cls.models.Sessions.create(id = cls.d.SessionOrphanage.id
        ...
        def notes(cls):
            ...
            """
            cls.models.Notes.create(id = cls.d.NoteOrphanage.id
        ...
        def places(cls):
            ...
            """
            cls.models.Places.create(id = cls.d.PlaceOrphanage.id
        ...
        def npcs(cls):
            ...
            """
            cls.models.NPCs.create(id = cls.d.NPCOrphanage.id
        ...
        def items(cls):
            ...
            """
            cls.models.Items.create(id = cls.d.ItemOrphanage.id
        ...
        def bridgeuserimages(cls):
            ...
            """
            cls.models.BridgeUserImages.create(id = cls.d.BridgeUserImageOrphanage.id
        ...
        def bridgeusergames(cls):
            ...
            """
            cls.models.BridgeUserGames.create(id = cls.d.BridgeUserGameOrphanage.id
        ...
        def bridgegamecharacters(cls):
            ...
            """
            cls.models.BridgeGameCharacters.create(id = cls.d.BridgeGameCharacterOrphanage.id
        ...
        def bridgegameplaces(cls):
            ...
            """
            cls.models.BridgeGamePlaces.create(id = cls.d.BridgeGamePlaceOrphanage.id
        ...
        def bridgegamenpcs(cls):
            ...
            """
            cls.models.BridgeGameNPCs.create(id = cls.d.BridgeGameNPCOrphanage.id
        ...
        def bridgegameitems(cls):
            ...
            """
            cls.models.BridgeGameItems.create(id = cls.d.BridgeGameItemOrphanage.id
