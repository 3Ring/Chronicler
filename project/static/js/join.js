...
document.addEventListener("DOMContentLoaded", function () {
  var elements__buttonCancel =
      document.getElementsByClassName(className__cancel),
    elements__buttonConfirm =
      document.getElementsByClassName(className__confirm),
    elements__selectGame = document.getElementsByClassName(
      className__selectGame
    ),
    elements__cardConfirm = document.getElementsByClassName(
      className__cardsConfirm
    );
  ...
  function hide() {
    for (let i = 0; i < elements__cardConfirm.length; i++) {
      if (elements__cardConfirm[i].classList.contains(className__hidden)) {
      } else {
