...
def send_new_note(user_id, game_id, note, priv=False, in_character=False):
    ...
    new=Notes(charname=current_char.name, note=note, session_number=session_number, priv=priv, in_character=in_character, character=current_char.id , user_id=user_id, game_id=game_id)
